...
@section('content')
    <div class="container">
        ...
        <!-- Input Pencarian -->
        <input type="text" id="search" class="form-control mt-3" placeholder="Cari buku berdasarkan judul, penulis, atau kategori...">
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchBooks() {
                $.ajax({
                    url: '/books/fetch', // Sesuaikan dengan route fetch
                    type: 'GET',
